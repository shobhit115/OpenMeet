...
export default function ControlBar({
    ...
    isChatOpen,
    leaveMeeting,
    meetingUrl // Optional prop: pass custom URL, otherwise defaults to window.location.href
}) {
        ...
        <div className="bg-gray-950/90 backdrop-blur-md border-t border-gray-800/80 px-4 py-3 flex justify-between items-center shrink-0 z-50">
            ...
            <div className="flex items-center gap-2.5 sm:gap-3 md:gap-4 mx-auto sm:mx-0">
                ...
                <button 
                    ...
                    title="Leave Call"
                    className="px-5 py-3.5 bg-red-600 hover:bg-red-700 text-white rounded-full transition-all duration-200 flex items-center gap-2 shadow-lg shadow-red-600/30"
                >
